...
# ╔═╡ 51cd1185-faea-4dfe-b3c5-1afbb65aa812
using LinearAlgebra, PlutoUI, Plots

# ╔═╡ 0f90fa6d-4515-4657-bed1-c7243d1de18e
md"
# Eigenvalues of Random Matrices
"

# ╔═╡ 789de7bf-a561-4f37-b666-a5946429bb6f
md"""
k = $(@bind k Slider(1:30,show_value=true))

n = $(@bind n Slider(10:30,show_value=true))

Matrix type = $(@bind mt Select(["Uniform", "Normal", "Uniform symmetric", "Normal Symmetric"]))
"""

# ╔═╡ b1d091de-d7b2-11ed-2831-ddf776a1cc52
begin
	scatter()
	for i=1:k
		if mt=="Uniform"
...
manifest_format = "2.0"
project_hash = "537438191877b3b1baa6aeb36cbc08c3a575a0b6"
