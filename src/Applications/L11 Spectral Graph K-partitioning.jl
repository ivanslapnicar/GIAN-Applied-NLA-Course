...
The suggested reading is [U. von Luxburg, A Tutorial on Spectral Clustering](http://www.kyb.mpg.de/fileadmin/user_upload/files/publications/attachments/luxburg06_TR_v2_4139%5b1%5d.pdf), which includes the quote
...
The reader should be familiar with the k-means algorithm, spectral graph bipartitioning, and recursive bipartitioning.
...
# ╔═╡ eaebe27b-bc80-4117-bf7f-8335bf48c635
begin
	nodelabel=1:nv(G)
	gplot(G,nodelabel=nodelabel, edgelabel=wn)
end
...
manifest_format = "2.0"
project_hash = "e1db293059502edafc902d0d2c51e41d7e62be67"
